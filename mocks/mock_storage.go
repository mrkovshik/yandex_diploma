...
// Source: github.com/mrkovshik/yandex_diploma/api (interfaces: Storage)
...
func (m *MockStorage) FinalizeOrderAndUpdateBalance(arg0 context.Context, arg1 string, arg2 int) error {
	m.ctrl.T.Helper()
